...
import com.hnf.honeycomb.bean.exception.TokenException;
...
//        claims.put("userName", policeNumber);
        ...
        addJwtKey(claims.get("police").toString(), key);
       /* // 下面就是在为payload添加各种标准声明和私有声明了
        ...
        JwtBuilder builder = Jwts.builder()
                ...
                .setSubject(claims.get("police").toString())
    ...
    public void addJwtKey(String policeNumber, SecretKey key) {
        ...
        String jwtKey = RedisUtilNew.USER_LOGIN_CHECK + policeNumber;
        // 令牌生成
